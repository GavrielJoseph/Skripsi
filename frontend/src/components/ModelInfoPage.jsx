...
// Confusion Matrix Component - Gaya Akademis/Teknis
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm">Spesifikasi arsitektur model, parameter hyper-tuning, dan log evaluasi klasifikasi.</p>
      </div>
